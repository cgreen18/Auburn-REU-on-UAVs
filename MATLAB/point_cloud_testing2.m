...
for i = 3:N_Frames
    ...
    tform = pcregistericp(moving, fixed, 'Metric','pointToPlane','Extrapolate', true, 'MaxIterations',40,'Tolerance',[0.001,0.005]);
...
clc
my_frame = 2; 
time_delta = data{1,my_frame}.timeStamp - data{1,my_frame-1}.timeStamp;
time_delta = single(time_delta)/(10^6)
